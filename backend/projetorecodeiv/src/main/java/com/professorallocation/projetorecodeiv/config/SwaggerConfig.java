...
import com.professorallocation.projetorecodeiv.ProjetorecodeivApplication;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage(ProjetorecodeivApplication.class.getPackage().getName()))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("Project for Professor Allocation")
